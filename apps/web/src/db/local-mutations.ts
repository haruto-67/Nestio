...
import { uuidv7, type SyncOp, type SyncableTable, type RetiredSyncTable, type UserSettingsRow } from '@nestio/shared';
...
type NonUserSettingsTable = Exclude<SyncableTable, 'user_settings' | RetiredSyncTable>;
